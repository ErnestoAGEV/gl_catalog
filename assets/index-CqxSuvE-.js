(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const V={name:"G&L",whatsapp:"523121018263",freeShippingMin:999},Te="523121018263",M={products:"gl_products",cart:"gl_cart",adminSession:"gl_admin_session",wishlist:"gl_wishlist",theme:"gl_theme",coupon:"gl_coupon",newsletter:"gl_newsletter"},Oe={WELCOME10:{discount:.1,label:"10% de descuento"},VERANO20:{discount:.2,label:"20% de descuento"},ENVIOGRATIS:{discount:0,freeShipping:!0,label:"Envío gratis"}},we={user:"admin",pass:"admin123"};function I(e,r){try{const t=localStorage.getItem(e);return t?JSON.parse(t):r}catch{return r}}function E(e,r){localStorage.setItem(e,JSON.stringify(r))}const L={camisas:["https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=600&h=750&fit=crop"],playeras:["https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=750&fit=crop"],pantalones:["https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1542272604-787c3835535d?w=600&h=750&fit=crop"],sudaderas:["https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1578768079052-aa76e52ff62e?w=600&h=750&fit=crop"],chamarras:["https://images.unsplash.com/photo-1551028719-00167b16eac5?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1559551409-dadc959f76b8?w=600&h=750&fit=crop"],perfumes:["https://images.unsplash.com/photo-1594035910387-fea47794261f?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&h=750&fit=crop"],general:["https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&h=750&fit=crop","https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=600&h=750&fit=crop"]},He=[{id:"p-oxford-01",name:"Camisa Oxford",type:"Camisas",price:799,originalPrice:999,colors:["Negro","Blanco","Azul Marino"],sizes:["S","M","L","XL"],badge:"Oferta",stock:8,rating:4.8,reviews:24,images:L.camisas},{id:"p-poplin-01",name:"Camisa Popelina Slim",type:"Camisas",price:849,originalPrice:null,colors:["Blanco","Azul Cielo","Negro"],sizes:["S","M","L","XL"],badge:"Nuevo",stock:15,rating:4.5,reviews:12,images:L.camisas},{id:"p-tee-01",name:"Playera Básica Premium",type:"Playeras",price:299,originalPrice:null,colors:["Negro","Blanco","Gris","Verde Olivo"],sizes:["S","M","L","XL","XXL"],badge:"Popular",stock:50,rating:4.9,reviews:89,images:L.playeras},{id:"p-tee-02",name:"Playera Oversize",type:"Playeras",price:349,originalPrice:449,colors:["Negro","Blanco","Arena"],sizes:["S","M","L","XL"],badge:"Oferta",stock:3,rating:4.6,reviews:31,images:L.playeras},{id:"p-polo-01",name:"Polo Piqué",type:"Polos",price:549,originalPrice:null,colors:["Negro","Azul Marino","Blanco"],sizes:["S","M","L","XL"],badge:null,stock:20,rating:4.7,reviews:18,images:L.general},{id:"p-jean-01",name:"Jeans Slim",type:"Pantalones",price:1099,originalPrice:1299,colors:["Azul","Negro"],sizes:["30","32","34","36","38"],badge:"Oferta",stock:12,rating:4.8,reviews:45,images:L.pantalones},{id:"p-jean-02",name:"Jeans Regular",type:"Pantalones",price:999,originalPrice:null,colors:["Azul Oscuro","Negro"],sizes:["30","32","34","36","38"],badge:null,stock:25,rating:4.4,reviews:22,images:L.pantalones},{id:"p-chino-01",name:"Pantalón Chino",type:"Pantalones",price:949,originalPrice:null,colors:["Negro","Beige","Verde Olivo"],sizes:["30","32","34","36","38"],badge:"Nuevo",stock:18,rating:4.6,reviews:15,images:L.pantalones},{id:"p-bermuda-01",name:"Short Chino",type:"Shorts",price:699,originalPrice:null,colors:["Negro","Beige"],sizes:["30","32","34","36"],badge:null,stock:10,rating:4.3,reviews:8,images:L.general},{id:"p-hoodie-01",name:"Sudadera Hoodie Minimal",type:"Sudaderas",price:899,originalPrice:1099,colors:["Negro","Gris"],sizes:["S","M","L","XL"],badge:"Popular",stock:6,rating:4.9,reviews:67,images:L.sudaderas},{id:"p-crewneck-01",name:"Sudadera Crewneck",type:"Sudaderas",price:849,originalPrice:null,colors:["Negro","Gris","Azul Marino"],sizes:["S","M","L","XL"],badge:null,stock:14,rating:4.5,reviews:19,images:L.sudaderas},{id:"p-sweater-01",name:"Suéter Tejido Fino",type:"Suéteres",price:899,originalPrice:null,colors:["Negro","Gris","Bordó"],sizes:["S","M","L","XL"],badge:"Nuevo",stock:9,rating:4.7,reviews:11,images:L.general},{id:"p-jacket-01",name:"Chamarra Urban",type:"Chamarras",price:1699,originalPrice:null,colors:["Negro"],sizes:["M","L","XL"],badge:null,stock:2,rating:4.8,reviews:28,images:L.chamarras},{id:"p-jacket-02",name:"Chamarra Bomber",type:"Chamarras",price:1899,originalPrice:2299,colors:["Negro","Verde Olivo"],sizes:["S","M","L","XL"],badge:"Oferta",stock:4,rating:4.9,reviews:52,images:L.chamarras},{id:"p-coat-01",name:"Abrigo de Paño",type:"Abrigos",price:2999,originalPrice:null,colors:["Negro","Gris"],sizes:["M","L","XL"],badge:"Premium",stock:5,rating:5,reviews:14,images:L.chamarras},{id:"p-perfume-01",name:"Perfume Intense Noir",type:"Perfumes",price:1299,originalPrice:1599,colors:["100ml","50ml"],sizes:["100ml","50ml"],badge:"Oferta",stock:12,rating:4.9,reviews:45,images:L.perfumes},{id:"p-perfume-02",name:"Perfume Fresh Ocean",type:"Perfumes",price:999,originalPrice:null,colors:["100ml","50ml"],sizes:["100ml","50ml"],badge:"Nuevo",stock:20,rating:4.7,reviews:32,images:L.perfumes},{id:"p-perfume-03",name:"Perfume Classic Wood",type:"Perfumes",price:1499,originalPrice:null,colors:["100ml"],sizes:["100ml"],badge:"Premium",stock:8,rating:5,reviews:28,images:L.perfumes},{id:"p-perfume-04",name:"Perfume Sport Energy",type:"Perfumes",price:799,originalPrice:999,colors:["100ml","50ml"],sizes:["100ml","50ml"],badge:"Popular",stock:25,rating:4.8,reviews:67,images:L.perfumes}],ke=3;function De(){const e=localStorage.getItem("gl_seed_version"),r=I(M.products,null);(e!==String(ke)||!Array.isArray(r)||r.length===0)&&(E(M.products,He),localStorage.setItem("gl_seed_version",String(ke)))}const re=new Set;function X(){const e=window.location.hash||"#/";return(e.startsWith("#")?e.slice(1):e)||"/"}function H(e){const r=e.startsWith("/")?e:`/${e}`;window.location.hash=`#${r}`}function Re(e){return re.add(e),()=>re.delete(e)}function Ve(){const e=()=>{for(const r of re)r(X())};return window.addEventListener("hashchange",e),e(),()=>{window.removeEventListener("hashchange",e)}}const ae=new Set,p={products:I(M.products,[]),cart:I(M.cart,[]),adminSession:I(M.adminSession,null),wishlist:I(M.wishlist,[]),theme:"light",coupon:I(M.coupon,null),newsletter:I(M.newsletter,null),searchQuery:""};function P(){for(const e of ae)e(oe())}function _e(e){return ae.add(e),()=>ae.delete(e)}function oe(){return structuredClone(p)}function Ge(){p.products=I(M.products,[]),P()}function Ce(e){p.products=e,E(M.products,e),P()}function Z(e){return p.products.find(r=>r.id===e)||null}function se({productId:e,size:r,color:t,qty:i}){const o=Math.max(1,Number(i)),a=`${e}__${r||""}__${t||""}`,n=p.cart.find(s=>s.key===a);n?n.qty+=o:p.cart.push({key:a,productId:e,size:r||"",color:t||"",qty:o}),E(M.cart,p.cart),P()}function ee(e,r){const t=p.cart.find(i=>i.key===e);t&&(t.qty=Math.max(1,Number(r||1)),E(M.cart,p.cart),P())}function We(e){p.cart=p.cart.filter(r=>r.key!==e),E(M.cart,p.cart),P()}function Y(){return p.cart.reduce((e,r)=>{const t=Z(r.productId),i=(t==null?void 0:t.price)||0;return e+i*(Number(r.qty)||0)},0)}function Fe(){return!!(p.adminSession&&p.adminSession.ok)}function Ue(e,r){const t=e===we.user&&r===we.pass;return p.adminSession=t?{ok:!0,at:Date.now()}:null,E(M.adminSession,p.adminSession),P(),t}function $e(){p.adminSession=null,E(M.adminSession,null),P()}function ne(e){const r=p.wishlist.indexOf(e);r===-1?p.wishlist.push(e):p.wishlist.splice(r,1),E(M.wishlist,p.wishlist),P()}function ie(e){return p.wishlist.includes(e)}function Xe(){return p.wishlist.map(e=>Z(e)).filter(Boolean)}function Qe(){return p.theme}function Je(){return p.theme=p.theme==="dark"?"light":"dark",E(M.theme,p.theme),P(),p.theme}function Me(e,r=!1){const t=e.toUpperCase().trim(),i=Oe[t];return i?(p.coupon={code:t,...i},E(M.coupon,p.coupon),r||P(),{success:!0,coupon:p.coupon}):{success:!1,error:"Cupón no válido"}}function Le(e=!1){p.coupon=null,E(M.coupon,null),e||P()}function J(){return p.coupon}function Ke(e){return p.newsletter={email:e,subscribedAt:Date.now()},E(M.newsletter,p.newsletter),P(),!0}function Ye(){var e;return!!((e=p.newsletter)!=null&&e.email)}function Q(e){p.searchQuery=e,P()}function Pe(){return p.searchQuery}function Ze(e){const r=e.toLowerCase().trim();return r?p.products.filter(t=>t.name.toLowerCase().includes(r)||t.type.toLowerCase().includes(r)||t.colors.some(i=>i.toLowerCase().includes(r))):p.products}function Ee(e,r="dark"){return`<div class="min-h-dvh overflow-x-hidden ${r==="dark"?"bg-black text-white":"bg-white text-gray-900"}">
  ...
  `,a)}function tt({contentHtml:e,state:r}){var i;const t=!!((i=r==null?void 0:r.adminSession)!=null&&i.ok);return Ee(`
  ...
  `}function Be(){const e=oe();[...e.products].slice(0,4);const r=[...e.products].sort((o,a)=>(a.reviews||0)-(o.reviews||0)).slice(0,4),t=e.products.filter(o=>o.badge==="Nuevo").slice(0,4),i=Ye();return{title:`${V.name} | Men´s Cloting`,html:`
  ...
  `}function gt(e){return{title:"Carrito | G&L",html:`
    ...
    `,onMount(t){const i=u(t,"#cart-list"),o=u(t,"#cart-total"),a=t.querySelector("#cart-total-final");(()=>{e.cart.length?i.innerHTML=e.cart.map(ut).join(""):i.innerHTML=`
          ...
          `;const d=Y();o.textContent=k(d),a&&(a.textContent=k(d))})();const s=d=>{var c;return(c=d.closest("[data-cart-item]"))==null?void 0:c.getAttribute("data-key")};j(t,"click","[data-remove]",(d,c)=>{const g=s(c);g&&We(g)}),j(t,"click","[data-qty-minus]",(d,c)=>{const g=c.closest("[data-cart-item]"),m=g==null?void 0:g.getAttribute("data-key"),h=g==null?void 0:g.querySelector("[data-qty]");if(!m||!(h instanceof HTMLInputElement))return;const w=Math.max(1,Number(h.value||1)-1);ee(m,w)}),j(t,"click","[data-qty-plus]",(d,c)=>{const g=c.closest("[data-cart-item]"),m=g==null?void 0:g.getAttribute("data-key"),h=g==null?void 0:g.querySelector("[data-qty]");if(!m||!(h instanceof HTMLInputElement))return;const w=Math.max(1,Number(h.value||1)+1);ee(m,w)}),j(t,"change","[data-qty]",(d,c)=>{const g=c.closest("[data-cart-item]"),m=g==null?void 0:g.getAttribute("data-key");!m||!(c instanceof HTMLInputElement)||ee(m,Number(c.value||1))})}}}function pt({customer:e,cartLines:r,subtotal:t,discount:i,couponCode:o,total:a}){const n=[];n.push("*NUEVO PEDIDO G&L*"),n.push(""),n.push("*DATOS DEL CLIENTE*"),n.push(`Nombre: ${e.name}`),n.push(`WhatsApp: ${e.whatsapp}`),n.push(`Pago: ${e.paymentMethod}`),n.push(`Entrega: ${e.deliveryMethod}`),e.address&&(n.push(""),n.push("*DIRECCION DE ENVIO*"),n.push(e.address)),n.push(""),n.push("*PRODUCTOS*");let s=1;for(const d of r){const c=[d.size?`Talla: ${d.size}`:null,d.color?`Color: ${d.color}`:null].filter(Boolean).join(" - ");n.push(`${s}. ${d.name}`),c&&n.push(`   ${c}`),n.push(`   Cant: ${d.qty} x ${k(d.price)} = ${k(d.subtotal)}`),n.push(""),s++}return n.push("*RESUMEN*"),t&&t!==a&&n.push(`Subtotal: ${k(t)}`),o&&i>0&&n.push(`Cupon ${o}: -${k(i)}`),n.push(`*TOTAL: ${k(a)}*`),n.join(`
`)}function mt(e){const r=encodeURIComponent(e),t=`https://wa.me/${Te}?text=${r}`;window.location.assign(t)}function Se(e,r){return r==="Envío a domicilio"}function xt(e){const r=Y(),t=J(),i=t?r*(t.discount||0):0,o=r-i,a=(t==null?void 0:t.freeShipping)||r>=V.freeShippingMin;return{title:"Checkout | G&L",html:`
    ...
    `,onMount(s){const d=u(s,"#checkout-form"),c=u(s,"#address-wrap"),g=u(s,"#form-error"),m=s.querySelector("#coupon-content"),h=s.querySelector("#discount-row"),w=s.querySelector("#discount-code"),v=s.querySelector("#discount-amount"),l=s.querySelector("#total-amount"),b=f=>{const z=Y(),A=f?z*(f.discount||0):0,_=z-A;if(f){m.innerHTML=`
            <div class="flex items-center justify-between bg-brand/10 border border-brand/30 rounded-lg p-3">
              <div class="flex items-center gap-2">
                <svg class="w-5 h-5 text-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                <div>
          ...
          `,h.classList.remove("hidden"),h.classList.add("flex"),w.textContent=f.code,v.textContent="-"+k(A);const B=s.querySelector("#remove-coupon");B&&B.addEventListener("click",()=>{Le(!0),b(null)})}else{m.innerHTML=`
            <div class="flex gap-2">
              <input id="coupon-input" type="text" placeholder="Código" class="flex-1 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2.5 text-sm text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-brand focus:outline-none uppercase"/>
              <button id="apply-coupon" class="px-4 py-2.5 bg-brand text-white text-sm font-semibold rounded-lg hover:bg-brand-dark transition-colors">Aplicar</button>
            </div>
            <p id="coupon-error" class="hidden text-xs text-red-500 mt-2"></p>
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-2">Prueba: <span class="font-medium text-brand">WELCOME10</span>, <span class="font-medium text-brand">VERANO20</span></p>
          `,h.classList.add("hidden"),h.classList.remove("flex");const B=s.querySelector("#apply-coupon"),D=s.querySelector("#coupon-input"),G=s.querySelector("#coupon-error");B&&D&&(B.addEventListener("click",()=>{const N=D.value.trim().toUpperCase();if(!N)return;const R=Me(N,!0);R.success?b(J()):(G.textContent=R.message||"Cupón inválido",G.classList.remove("hidden"))}),D.addEventListener("keypress",N=>{N.key==="Enter"&&(N.preventDefault(),B.click())}))}l.textContent=k(_)},x=s.querySelector("#coupon-input"),y=s.querySelector("#apply-coupon"),C=s.querySelector("#remove-coupon"),S=s.querySelector("#coupon-error");y&&x&&(y.addEventListener("click",()=>{const f=x.value.trim().toUpperCase();if(!f)return;const z=Me(f,!0);z.success?b(J()):(S.textContent=z.message||"Cupón inválido",S.classList.remove("hidden"))}),x.addEventListener("keypress",f=>{f.key==="Enter"&&(f.preventDefault(),y.click())})),C&&C.addEventListener("click",()=>{Le(!0),b(null)});const q=()=>{const f=u(s,'select[name="paymentMethod"]').value,z=u(s,'select[name="deliveryMethod"]').value;c.classList.toggle("hidden",!Se(f,z))},$=f=>{if(!f){g.classList.add("hidden"),g.textContent="";return}g.textContent=f,g.classList.remove("hidden")};q(),j(s,"change",'select[name="paymentMethod"],select[name="deliveryMethod"]',()=>{$(""),q()}),d.addEventListener("submit",f=>{var de,ce,ue,ge,pe,me,xe,he;if(f.preventDefault(),$(""),!e.cart.length){$("Tu carrito está vacío. Volvé al catálogo para agregar productos.");return}const z=u(s,'input[name="name"]').value.trim(),A=u(s,'input[name="whatsapp"]').value.trim(),_=u(s,'select[name="paymentMethod"]').value,B=u(s,'select[name="deliveryMethod"]').value;if(!z)return $("Ingresa tu nombre.");if(!A)return $("Ingresa tu WhatsApp.");if(!_)return $("Selecciona un método de pago.");if(!B)return $("Selecciona un método de entrega.");const D=Se(_,B);let G="";if(D){const T=((de=s.querySelector('input[name="street"]'))==null?void 0:de.value.trim())||"",O=((ce=s.querySelector('input[name="numExt"]'))==null?void 0:ce.value.trim())||"",F=((ue=s.querySelector('input[name="numInt"]'))==null?void 0:ue.value.trim())||"",U=((ge=s.querySelector('input[name="neighborhood"]'))==null?void 0:ge.value.trim())||"",be=((pe=s.querySelector('input[name="city"]'))==null?void 0:pe.value.trim())||"",fe=((me=s.querySelector('input[name="zipCode"]'))==null?void 0:me.value.trim())||"",ve=((xe=s.querySelector('input[name="state"]'))==null?void 0:xe.value.trim())||"",ye=((he=s.querySelector('textarea[name="references"]'))==null?void 0:he.value.trim())||"";if(!T)return $("Ingresa la calle.");if(!O)return $("Ingresa el número exterior.");if(!U)return $("Ingresa la colonia.");if(!be)return $("Ingresa la ciudad.");if(!fe)return $("Ingresa el código postal.");if(!ve)return $("Ingresa el estado.");G=`${T} #${O}${F?" Int. "+F:""}, Col. ${U}, ${be}, ${ve}, C.P. ${fe}${ye?" | Ref: "+ye:""}`}const N=e.cart.map(T=>{const O=Z(T.productId);if(!O)return null;const F=Number(T.qty)||0,U=Number(O.price)||0;return{name:O.name,type:O.type,size:T.size,color:T.color,qty:F,price:U,subtotal:F*U}}).filter(Boolean),R=Y(),W=J(),le=W?R*(W.discount||0):0,Ie=R-le,Ne=pt({customer:{name:z,whatsapp:A,paymentMethod:_,deliveryMethod:B,address:D?G:""},cartLines:N,subtotal:R,discount:le,couponCode:(W==null?void 0:W.code)||null,total:Ie});mt(Ne)})}}}function ht(e){var o;const r=((o=e.images)==null?void 0:o[0])||"https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=200&h=200&fit=crop",t=(e.sizes||[]).map(a=>`<option value="${a}">${a}</option>`).join(""),i=(e.colors||[]).map(a=>`<option value="${a}">${a}</option>`).join("");return`
  ...
  `}function vt(e){return{title:"Productos | Admin",html:`
    ...
    `,onMount(t){const i=u(t,"#products-list"),o=u(t,"#product-form"),a=u(t,"#product-error"),n=u(t,"#product-reset"),s=m=>{if(!m){a.classList.add("hidden"),a.textContent="";return}a.textContent=m,a.classList.remove("hidden")},d=()=>{if(!e.products.length){i.innerHTML=`
          ...
          `;return}i.innerHTML=e.products.map(ft).join("")},c=()=>{o.reset(),u(t,'input[name="id"]').value="",s("")};d(),u(t,"#admin-logout-btn").addEventListener("click",()=>{$e(),H("/admin")}),n.addEventListener("click",()=>c()),o.addEventListener("submit",m=>{m.preventDefault(),s("");const h=u(t,'input[name="id"]'),w=u(t,'input[name="name"]').value.trim(),v=u(t,'input[name="type"]').value.trim(),l=Number(u(t,'input[name="price"]').value||0),b=ze(u(t,'input[name="sizes"]').value),x=ze(u(t,'input[name="colors"]').value);if(!w)return s("Ingresá el nombre del producto.");if(!v)return s("Ingresá el tipo de prenda.");if(!Number.isFinite(l)||l<=0)return s("Ingresá un precio válido mayor a 0.");if(!b.length)return s("Ingresá al menos una talla.");if(!x.length)return s("Ingresá al menos un color.");const y=[...e.products];if(h.value){const C=y.findIndex(S=>S.id===h.value);if(C===-1)return s("No se encontró el producto a editar.");y[C]={...y[C],name:w,type:v,price:l,sizes:b,colors:x}}else{const C=`p-${crypto.randomUUID()}`;y.unshift({id:C,name:w,type:v,price:l,sizes:b,colors:x})}Ce(y),c(),H("/admin/products")}),j(t,"click","[data-edit]",(m,h)=>{const w=h.closest("[data-product]"),v=w==null?void 0:w.getAttribute("data-id"),l=e.products.find(b=>b.id===v);l&&(u(t,'input[name="id"]').value=l.id,u(t,'input[name="name"]').value=l.name,u(t,'input[name="type"]').value=l.type,u(t,'input[name="price"]').value=String(l.price),u(t,'input[name="sizes"]').value=l.sizes.join(", "),u(t,'input[name="colors"]').value=l.colors.join(", "))}),j(t,"click","[data-delete]",(m,h)=>{const w=h.closest("[data-product]"),v=w==null?void 0:w.getAttribute("data-id");if(!v)return;const l=e.products.filter(b=>b.id!==v);Ce(l)}),j(t,"click","#admin-logout",()=>{$e(),H("/admin/login")})}}}const yt={"/":Be,"/catalog":ct,"/cart":gt,"/checkout":xt,"/wishlist":bt},wt={"/admin/login":qe,"/admin/products":vt};function kt(e,r){const t=e.startsWith("/admin"),a=((t?wt:yt)[e]||(t?qe:Be))(r),n=a.title;return t?{title:n,html:tt({contentHtml:a.html,state:r}),onMount:a.onMount}:{title:n,html:et({contentHtml:a.html,state:r,showSearch:a.showSearch}),onMount:a.onMount}}function Ct(e){De(),Ge();const r=()=>{const s=Qe();document.documentElement.classList.toggle("dark",s==="dark"),document.body.classList.toggle("bg-black",s==="dark"),document.body.classList.toggle("bg-white",s==="light")};r();const t=s=>{const d=Fe();if(d&&!s.startsWith("/admin")){H("/admin/products");return}if(!d&&s.startsWith("/admin")&&s!=="/admin/login"){H("/admin/login");return}const{title:c,html:g,onMount:m}=kt(s,oe());document.title=c,e.innerHTML=g,m==null||m(e),i()},i=()=>{const s=document.getElementById("theme-toggle");s&&s.addEventListener("click",()=>{Je(),r(),t(X())});const d=document.getElementById("global-search");d&&d.addEventListener("keypress",c=>{if(c.key==="Enter"){const g=c.target.value.trim();Q(g),H("/catalog")}}),window.addEventListener("navigate",()=>t(X()),{once:!0})},o=Re(t),a=Ve();t(X());const n=_e(()=>{const s=X();["/cart","/wishlist","/checkout"].some(c=>s.startsWith(c))&&t(s)});return()=>{a(),o(),n()}}Ct(document.querySelector("#app"));
